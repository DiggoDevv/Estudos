...
//FUNÇÃO: 
//vantagens: consegue dizer se/quando eu quero q a função seja executada
//uma função pode funcionar com diversos tipos de textos
...
function soma(){
  return 2 + 2;
  //retorna o valor da funcao para fora do bloco de código
}

//console.log(soma())


//mais exemplos funções
